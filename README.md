...
```java
public class PranavDeshpande {

    String name        = "Pranav Deshpande";
    String college     = "PICT, Pune — Final Year Undergrad";
    String role        = "Aspiring Software Developer";
    String[] interests = {"Backend Systems", "AI/ML Integration", "Full-Stack Development"};

    String[] currentlyWorking = {
        "Spring AI & RAG-based systems",
...
- 🔭 Currently building **AI-powered applications** using Spring Boot & Spring AI
- 🌱 Exploring **Retrieval-Augmented Generation (RAG)**, **LangChain**, and **distributed systems**
- 💡 Passionate about turning ideas into **scalable, production-ready systems**
